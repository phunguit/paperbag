...
class Image extends \Phalcon\Mvc\User\Plugin
{
    ...
    public function small($image = false, $altImage = 'no-image.png')
    {
    ...
    public function medium($image = false, $altImage = 'no-image.png')
    {
        if (!$image || !file_exists($this->imagesDir . $image)) {
            $image = $altImage;
        }
    ...
    public function large($image = false, $altImage = 'no-image.png')
    {
        if (!$image || !file_exists($this->imagesDir . $image)) {
            $image = $altImage;
        }
