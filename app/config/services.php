...
$di->set('db', function () use ($config) {
    ...
    $logger = new LogAdapter($config->application->logsDir . date('Y-m-d') . '-sql.log');
...
/**
 * Enables message translation service by using language plugin
 */
...
/**
 * The image component generates all resizable image urls while creating its cache file
 */
